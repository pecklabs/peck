...
enum I18n {
    ...
    static let ko: [String: String] = [
        ...
        "Save key": "키 저장",
        "Model": "모델",
        "Explanation language": "설명 언어",
        "Review language": "리뷰 언어",
        "Shown only to you.": "나에게만 표시됩니다.",
        "Posted to GitHub.": "GitHub에 게시됩니다.",
        // Settings — behavior
        "General": "일반",
        "Review requests": "리뷰 요청",
        "Auto-review on open": "오픈 시 자동 리뷰",
        "Auto re-review on new commits": "커밋 시 자동 재리뷰",
        "Auto-review on request": "요청 시 자동 리뷰",
        "Auto-submit when done": "완료 시 자동 제출",
        "Notifications": "알림",
